...
String ls_fecha_publicacion = request.getParameter("fecha_publicacion");
out.println(ls_fecha_publicacion);
...
ls_query = " insert into libros (isbn, titulo, autor, fechaPublicacion, idEditorial)";
ls_query += " values (";
ls_query += "'" + ls_isbn + "',";
ls_query += "'" + ls_titulo + "',";
ls_query += "'" + ls_autor + "',";
ls_query += "'" + ls_fecha_publicacion+ "',";
...
ls_query += " set titulo= " + "'" + ls_titulo + "'" + ", autor= " +"'"+ls_autor+"'" + ", idEditorial= " + "'"+ls_editorial+"'" + ",fechaPublicacion=" + "'" +ls_fecha_publicacion + "'";
ls_query += " where isbn = " + "'" + ls_isbn + "'";
}
if (ls_action.equals("ascendente")) {
...
//response.sendRedirect("http://localhost:8080/SUCARNET/libros.jsp");
